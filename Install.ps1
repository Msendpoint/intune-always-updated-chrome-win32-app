<#
.SYNOPSIS
    One-click installer and launcher for Deploy Always-Updated Google Chrome via Intune Win32 App
...
Write-Host "    Deploy Always-Updated Google Chrome via Intune Win32 App" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-always-updated-chrome-win32-app.ps1"
